...
export declare function addSocketId(userId: number, socketid: string): Promise<void>;
export declare function getSocketId(userId: number): Promise<string | null>;
export declare function removeSocketId(userId: number): Promise<void>;
